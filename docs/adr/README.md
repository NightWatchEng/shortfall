...
| [0020](0020-optional-registry-blocks.md) | baseline, recovery and reconcile are optional per flow; a leg without its block is unavailable, never guessed | accepted |
